...
/* Sprite sheets */
const demonIdle = SpriteSheet.fromImageSource({
  image: images.demon_idle,
  grid: {
    columns: 10,
    rows: 8,
    spriteWidth: 128,
...
const demonRun = SpriteSheet.fromImageSource({
  image: images.demon_run,
  grid: {
    columns: 10,
    rows: 8,
    spriteWidth: 128,
...
export const demonAnimations: AnimationData = {
  idle: {
    down: Animation.fromSpriteSheetCoordinates({
      spriteSheet: demonIdle,
