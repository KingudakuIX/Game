...
export const mannequinAnimations: AnimationData = {
  idle: {
    down: Animation.fromSpriteSheetCoordinates({
      ...
      frameCoordinates: generateFramesCoordinates("horizontal", 0, [0, 7], 100),
    }),
    down_right: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 1, [0, 7], 100),
    }),
    right: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 2, [0, 7], 100),
    }),
    up_right: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 3, [0, 7], 100),
    }),
    up: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 4, [0, 7], 100),
    }),
    up_left: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 5, [0, 7], 100),
    }),
    left: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 6, [0, 7], 100),
    }),
    down_left: Animation.fromSpriteSheetCoordinates({
      spriteSheet: mannequinIdle,
      frameCoordinates: generateFramesCoordinates("horizontal", 7, [0, 7], 100),
    }),
  },
  running: {
    down: Animation.fromSpriteSheetCoordinates({
